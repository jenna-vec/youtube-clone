    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static">
        <Toolbar sx={{ "justifyContent": "space-between" }} >
          <div className='row'>
            <div className='logo-box'>
              <svg viewBox="0 0 90 20" preserveAspectRatio="xMidYMid meet" focusable="false">
                <g viewBox="0 0 90 20" preserveAspectRatio="xMidYMid meet" className="logo">
                  <g>
            ...
            <form onSubmit={searchButton}>
              <div className='search-bar'>
                <input id="search" placeholder='Search ID' onChange={(e) => onInput(e.target.value)} onKeyDown={searchEnter} />
          ...
          <div onClick={toggleHistory} style={{ "cursor": "pointer" }} >
